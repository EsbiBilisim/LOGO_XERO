...
{
    public class LOGO_XERO_SIPARIS_SATIR 
    {
        ...
        public DateTime? SATINALMAOPSIYONTARIHI { get; set; }
        ...
        public short? BASLIKDOVIZTURU { get; set; }

        public short? SATIRDOVIZTURU { get; set; }
